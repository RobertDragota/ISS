...
public class ProgrammerTermianlGui extends Stage {
    ...
    public ProgrammerTermianlGui(ServicesDispacher servicesDispacher, String controllerName, Stage parentStage) {
    ...
    private void SetUp(ServicesDispacher servicesDispacher, String controllerName) {
        ...
        try {
            ...
            ProgrammerTerminalController controller = loader.getController();
